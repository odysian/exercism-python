...
def approx_average_is_average(hand):
    ...
    if n % 2 == 0:
        median_val = (sorted_hand[middle_index - 1] + sorted_hand[middle_index]) / 2
    else:
        median_val = sorted_hand[middle_index]

    return average == first_last_avg or median_val == average
